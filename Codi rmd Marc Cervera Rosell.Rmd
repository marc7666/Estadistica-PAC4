...
Per interpretar els resultats del model ANOVA, es continuarà usant un nivell de significança del 0.01. Com s'observa al _summary_ del model la variable _Education_ té un fort impacte en els ingressos de les persones a causa del fet que el valor p associat a la variable explicativa és menor al nivell de significança (0.01).
